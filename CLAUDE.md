...
2. Implement game simulation logic in client/src/utils/
3. Create React components for scoreboard, play-by-play, stats
4. Build running algorithm (1-4 vs 1-5 matching game)
5. Implement pass/kick probability tables
6. Add automated play sequencing with configurable delays
